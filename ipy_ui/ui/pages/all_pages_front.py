...
class UI_SubscribersPage(object):
    ...
    def setupUi(self, Form):
        ...
        self.comboBox.setMinimumSize(QtCore.QSize(250, 25))
        self.comboBox.setMaximumSize(QtCore.QSize(250, 25))
...
class UI_FindPage(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "\nВведите в верхней строке поиска, абонента"
...
class UI_CreateTicketPage(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Тут могло быть что-то...\n— Но ничего нет!"))


# Окно посмотреть тикеты
class UI_TicketsInfoPage(object):
...
def errorWindow(message, text):
    error = QMessageBox()
    error.setWindowIcon(QIcon('ui/ico_main/error.png'))
