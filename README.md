...
При открытии вкладки Абоненты или запроса в поисковую строку, создается запрос к Базе с указанием ключевого слова илил всех абонентов.
Отображение в режимо просмотра, и редактирования.
